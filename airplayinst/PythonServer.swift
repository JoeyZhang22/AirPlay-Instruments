...
class PythonServer: ObservableObject {
    ...
    func start() {
        ...
        let scriptPath = "/Users/loganclarke/Desktop/Airplay_App/airplayinst/airplayinst/PythonBackEnd/main.py"
        // Ensure the correct Python interpreter path
        let pythonPath = "/opt/anaconda3/bin/python3" // Adjust if necessary
