...
class Recognizer:
    ...
    def transform_recognized_output(
        self,
    ):
...
def transform_recognition_output(recognition_result, areas):
    ...
    for hand_index, hand_landmarks in enumerate(recognition_result.hand_landmarks):
        ...
        transformed_output["Handedness"] = recognition_result.handedness[hand_index][
            0
        ].category_name
        transformed_output["Gesture_Type"] = recognition_result.gestures[hand_index][
            0
        ].category_name
